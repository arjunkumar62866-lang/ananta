            ...
            <div class="container-fluid">
                ...
                <div class="card income-header-card p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h3 class="mb-1" style="font-weight: 800; color: #0f172a;">Direct Income History</h3>
                            <p class="mb-0" style="color: #64748b; font-weight: 600; font-size: 14px;">Complete ledger of direct referral commission rewards across member accounts.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card ananta-fintech-card">
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4>Direct Income Transactions</h4>
                                    <p>Live transaction logs & referral rewards</p>
                                </div>
