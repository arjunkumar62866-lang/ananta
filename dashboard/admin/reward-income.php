...
<style>
/* =========================================================
   ANANTA FINTECH THEME - RANK & REWARDS REDESIGN
========================================================= */
html, body {
    min-height: 100%;
    margin: 0;
...
.income-header-card {
    background: linear-gradient(135deg, rgba(2, 132, 199, 0.10) 0%, rgba(234, 179, 8, 0.10) 100%), #ffffff !important;
            ...
            <div class="container-fluid">
                ...
                <div class="card income-header-card p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h3 class="mb-1" style="font-weight: 800; color: #0f172a;">Rank & Rewards History</h3>
                            <p class="mb-0" style="color: #64748b; font-weight: 600; font-size: 14px;">Statements of special physical/monetary rewards achieved by rank performers.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card ananta-fintech-card">
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4>Rank and Reward Transactions</h4>
                                    <p>Live transaction logs & reward distribution</p>
                                </div>
