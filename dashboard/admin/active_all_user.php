...
<style>
/* =========================================================
   ANANTA FINTECH THEME - ACTIVE USERS REDESIGN
========================================================= */
html, body {
    min-height: 100%;
    margin: 0;
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            <span class="badge" style="background: rgba(22, 163, 74, 0.15); color: #16a34a; font-size: 11px; font-weight: 700; border-radius: 100px; padding: 4px 12px; letter-spacing: 0.5px;">ACTIVE ACCOUNTS</span>
                                            <span style="font-size: 12px; color: #64748b; font-weight: 600;">ACTIVE MEMBERS</span>
                                        </div>
                                        <h4 class="mb-0" style="font-size: 22px; font-weight: 800; color: #0f172a;">
                                            All Active <span style="background: linear-gradient(135deg, #16a34a 0%, #0284c7 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Users</span> ✅
                                        </h4>
                                        <p class="mb-0 text-muted" style="font-size: 13.5px; margin-top: 3px;">
                                            Directory of all active paid user accounts.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="ananta-fintech-card">
                            ...
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4><i class="fa fa-check-circle text-success me-2"></i> Active Users List</h4>
                                    <p>Comprehensive register of active package holders</p>
                                </div>
                                <div>
