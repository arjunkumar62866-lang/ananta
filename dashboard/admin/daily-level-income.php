...
.income-header-card {
    background: linear-gradient(135deg, rgba(2, 132, 199, 0.10) 0%, rgba(20, 184, 166, 0.10) 100%), #ffffff !important;
            ...
            <div class="container-fluid">
                ...
                <div class="card income-header-card p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h3 class="mb-1" style="font-weight: 800; color: #0f172a;">Profit Sharing Income History</h3>
                            <p class="mb-0" style="color: #64748b; font-weight: 600; font-size: 14px;">Detailed transaction log of downline daily level profit sharing payouts.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card ananta-fintech-card">
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4>Profit Sharing Payouts</h4>
                                    <p>Live transaction logs & daily profit shares</p>
                                </div>
        ...
        $(document).ready(function () {
            let table = $('#usersTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Profit_Sharing_Income_Report'
                    }
                ]
            });
