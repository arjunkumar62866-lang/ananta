...
.income-header-card {
    background: linear-gradient(135deg, rgba(2, 132, 199, 0.10) 0%, rgba(99, 102, 241, 0.10) 100%), #ffffff !important;
            ...
            <div class="container-fluid">
                ...
                <div class="card income-header-card p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h3 class="mb-1" style="font-weight: 800; color: #0f172a;">Ranking Income History</h3>
                            <p class="mb-0" style="color: #64748b; font-weight: 600; font-size: 14px;">Statements of rank-based achievement payouts credited to members.</p>
                        </div>
                    </div>
                </div>
