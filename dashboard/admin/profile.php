...
if (isset($_POST['submit'])) {
    ...
    if ($adhar_front_img_name != '') {
        if ($adhar_front_img_size <= $maxFileSize) {
            ...
            if ($upload) {
                // pdate image in DB
                $stmt = $pdo->prepare("UPDATE user SET image = :image WHERE userid = :userid");
            ...
            echo '<script>alert("Please upload an image smaller than 200KB.");</script>';
        }
    }
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="mobile" id="mobile"
                                    value="<?php echo $usermobile; ?>" readonly>
                            </div>
