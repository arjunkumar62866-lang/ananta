...
<style>
/* =========================================================
   ANANTA FINTECH THEME - BLOCKED USERS REDESIGN
========================================================= */
html, body {
    min-height: 100%;
    margin: 0;
...
.income-header-card {
    background: linear-gradient(135deg, rgba(225, 29, 72, 0.10) 0%, rgba(245, 158, 11, 0.10) 100%), #ffffff !important;
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            <span class="badge" style="background: rgba(225, 29, 72, 0.15); color: #e11d48; font-size: 11px; font-weight: 700; border-radius: 100px; padding: 4px 12px; letter-spacing: 0.5px;">BLOCKED ACCOUNTS</span>
                                            <span style="font-size: 12px; color: #64748b; font-weight: 600;">RESTRICTED ACCESS</span>
                                        </div>
                                        <h4 class="mb-0" style="font-size: 22px; font-weight: 800; color: #0f172a;">
                                            All Blocked <span style="background: linear-gradient(135deg, #e11d48 0%, #f59e0b 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Users</span> 🚫
                                        </h4>
                                        <p class="mb-0 text-muted" style="font-size: 13.5px; margin-top: 3px;">
                                            List of blocked or suspended user accounts in the system.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="ananta-fintech-card">
                            ...
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4><i class="fa fa-ban text-danger me-2"></i> Blocked Accounts Log</h4>
                                    <p>Manage and unblock suspended accounts</p>
                                </div>
                                <div>
