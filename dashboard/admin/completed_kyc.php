...
<style>
/* =========================================================
   ANANTA FINTECH THEME - COMPLETED KYC REDESIGN
========================================================= */
html, body {
    min-height: 100%;
    margin: 0;
            ...
            <div class="container-fluid">
                ...
                <div class="card income-header-card p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h3 class="mb-1" style="font-weight: 800; color: #0f172a;">Completed KYC Records</h3>
                            <p class="mb-0" style="color: #64748b; font-weight: 600; font-size: 14px;">View verified user accounts and compliance details.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card ananta-fintech-card">
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4>Verified Members List</h4>
                                    <p>Approved KYC verification database</p>
                                </div>
            ...
            let table = $('#usersTable').DataTable({
                ...
                columns: [
                    ...
                    { data: 'holder_name' },
                    {
                        data: null,
                        render: function () {
                            return `<span class="status-badge status-completed"><i class="fa fa-check-circle me-1"></i>Completed</span>`;
                        }
                    },
                    {
                        data: 'userid',
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Completed_KYC_Members_Data'
                    }
                ]
            });
