            ...
            <div class="container-fluid">
                ...
                <div class="card income-header-card p-4">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div>
                            <h3 class="mb-1" style="font-weight: 800; color: #0f172a;">Generation Income History</h3>
                            <p class="mb-0" style="color: #64748b; font-weight: 600; font-size: 14px;">Complete statement of team generation income payouts across all member accounts.</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card ananta-fintech-card">
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4>Generation Income Transactions</h4>
                                    <p>Live transaction logs & history</p>
                                </div>
        ...
        $(document).ready(function () {
            let table = $('#usersTable').DataTable({
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Generation_Income_Report'
                    }
                ]
            });
