$(function() {
    ...
    if (chart1El && typeof Chart !== 'undefined') {
        ...
        var myChart = new Chart(ctx, {
            ...
            options: {
                ...
                legend: {
                    display: false,
                    labels: { fontColor: '#ddd', boxWidth: 40 }
                },
                tooltips: { displayColors: false },
                scales: {
                    xAxes: [{ ticks: { beginAtZero: true, fontColor: '#ddd' }, gridLines: { display: true, color: "rgba(221, 221, 221, 0.08)" } }],
                    yAxes: [{ ticks: { beginAtZero: true, fontColor: '#ddd' }, gridLines: { display: true, color: "rgba(221, 221, 221, 0.08)" } }]
                }
            }
        });
    }
    ...
    if (chart2El && typeof Chart !== 'undefined') {
        ...
        var myChart = new Chart(ctx, {
            ...
            options: {
                maintainAspectRatio: false,
                legend: { position: "bottom", display: false, labels: { fontColor: '#ddd', boxWidth: 15 } },
                tooltips: { displayColors: false }
            }
        });
    }
