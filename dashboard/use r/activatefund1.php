...
include "common/tree_method.php";
...
if (isset($_POST["submit"])) {
    ...
    if ($rowheader) {
        ...
        if ($pkg_id == 1) {
            ...
            if ($amount < 1200000 || $amount > 2000000) {
                $error[] = "Amount must be between ₹1200000 and ₹2000000 for package '$pkg_name'";
            }
        }
        ...
        if ($price > 0) {
            if ($pin_wallet >= $amount) {
                ...
                while ($rowuser = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    $sponserid11 = $rowuser['sponserid'];
                    $password    = $rowuser['pass'];
                    $mobile      = $rowuser['mobile'];
                }
                
                checkfreleg($sponserid11,$userid,$sponserid11,$password,$mobile);
                //
                  ...
                  <div class="tile">
                    <form method="post" id="form-data">
                      ...
                      <div class="form-group">
                        <a href="fund_request">Your ID Activation is Pending Click here to Send Fund Request</a>
                      </div>
