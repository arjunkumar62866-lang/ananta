...
if (isset($_POST["submit"])) {
    ...
    $packname = "Without Guarantee" ?? $rowheader["name"];
    $days = 1350 ?? $rowheader["days"];
    $lockdays = 1350 ?? $rowheader["days"];
                ...
                if (1==1) {
                    ...
                    if (
                        ...
                        if($active=="1"){
                            ...
                            $percentage = 10; // Default if outside all ranges
                        }
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h3 class="tile-title text-center">
                            Join Without Guarantee Program
