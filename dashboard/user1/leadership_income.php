...
// Calculate Total Leadership Income for header stat
$table = "tbl_transaction";
$leadership_income_total = incometotalnew($pdo, $table, $userid, 'Leadership Income');
$leadership_income_total = round((float)($leadership_income_total ?? 0), 2);
?>
...
/* Header Banner */
.income-header-card {
    background: linear-gradient(135deg, rgba(225, 29, 72, 0.10) 0%, rgba(2, 132, 199, 0.10) 100%), #ffffff !important;
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            <span class="badge" style="background: rgba(225, 29, 72, 0.15); color: #e11d48; font-size: 11px; font-weight: 700; border-radius: 100px; padding: 4px 12px; letter-spacing: 0.5px;">LEADERSHIP BONUS</span>
                                            <span style="font-size: 12px; color: #64748b; font-weight: 600;">TURNOVER BONUS</span>
                                        </div>
                                        <h4 class="mb-0" style="font-size: 22px; font-weight: 800; color: #0f172a;">
                                            Leadership <span style="background: linear-gradient(135deg, #e11d48 0%, #be123c 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Bonus Statement</span> ⭐
                                        </h4>
                                        <p class="mb-0 text-muted" style="font-size: 13.5px; margin-top: 3px;">
                                            History of company turnover sharing and leadership bonus pool allocations.
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <div class="px-3 py-2" style="background: #ffffff; border-radius: 14px; border: 1px solid rgba(225, 29, 72, 0.2); box-shadow: 0 4px 12px rgba(15, 23, 42, 0.04);">
                                        <span class="text-muted d-block" style="font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Total Leadership Bonus</span>
                                        <span class="font-weight-bold" style="font-size: 18px; color: #e11d48; font-weight: 800;"><?php echo $hmcurrency . " " . number_format($leadership_income_total, 2); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ananta-fintech-card">
                            ...
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4><i class="fa fa-medal text-danger me-2"></i> Leadership Income Log</h4>
                                    <p>Real-time record of leadership bonus payouts</p>
                                </div>
        ...
        $(document).ready(function () {
            let table = $('#usersTable').DataTable({
                ...
                columns: [
                    ...
                    { 
                        data: 'subject',
                        render: (data) => '<span style="font-weight: 600; color: #1e293b;">' + (data || 'Leadership Income') + '</span>'
                    },
                    { 
                        data: 'type',
                    ...
                    { 
                        data: 'created_date',
                        render: (data) => '<span style="color: #64748b; font-size: 13px;"><i class="fa fa-calendar-o me-1 text-danger"></i>' + (data || 'N/A') + '</span>'
                    },
                    { 
                        data: 'time',
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Leadership_Bonus_Statement'
                    }
                ],
                language: {
                    search: "_INPUT_",
                    searchPlaceholder: "Search leadership bonus...",
