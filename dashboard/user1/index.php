          ...
          <div class="card-content">
            ...
            <div class="col-12 col-md-6 col-lg-3">
                <div class="wallet-box d-flex align-items-center px-3 py-3">
                    ...
                    <div class="ml-3">
                        <h6 class="wallet-title mb-1">Pending Generation income</h6>
                        <h5 class="wallet-amount mb-1"><?php echo "$hmcurrency ".round((double)$pending_geninc, 2);; ?></h5>
                    </div>
            ...
            <div class="card-body" style=" padding: 25px; margin-top: 20px; color: white; box-shadow: 0 2px 15px rgba(0,0,0,0.6); border: 1px solid rgba(255,255,255,0.1);">
                ...
                <div class="input-group mb-3" style="display: flex; gap: 10px; flex-wrap: wrap;">
                    <input 
                        ...
                        value="<?php echo $hmurl; ?>user1/add_user_binary_registration_form.php?sponsorid=<?php echo $userid; ?>&underuserid=<?php echo $userid; ?>&type=left" 
                        readonly
                    >
                    ...
                    <a
                        ...
                        data-toggle="tooltip" 
                        title="Copy to Clipboard" 
                        href="<?php echo $hmurl; ?>user1/add_user_binary_registration_form.php?sponsorid=<?php echo $userid; ?>&underuserid=<?php echo $userid; ?>&type=left"
                    >
                        <button 
                            type="button" 
                            class="btn" 
                ...
                <div class="input-group mb-3" style="display: flex; gap: 10px; flex-wrap: wrap;">
                    <input 
                        ...
                        style=" border: 1px solid rgba(255,255,255,0.1); color: #000; border-radius: 10px; padding: 12px; flex: 1; font-size: 14px;" 
                        title="Copy to Clipboard" 
                        value="<?php echo $hmurl; ?>user1/add_user_binary_registration_form.php?sponsorid=<?php echo $userid; ?>&underuserid=<?php echo $userid; ?>&type=right" 
                        readonly
                    >
                    ...
                    <a
                        ...
                        data-toggle="tooltip" 
                        title="Copy to Clipboard" 
                        href="<?php echo $hmurl; ?>user1/add_user_binary_registration_form.php?sponsorid=<?php echo $userid; ?>&underuserid=<?php echo $userid; ?>&type=right"
                    >
                        <button 
                            type="button" 
                            class="btn" 
                ...
                <div class="input-group mt-3" style="display: flex;">
                    <a 
                        href="https://youtube.com/@anantamelodyverse?si=qIDQyBt9kS0s4A0F" 
                        target="_blank"
                        class="form-control btn btn-primary"
                        style="background-color:#FF0000; color: white; font-weight: 600; padding: 12px 18px; border-radius: 10px; text-align: center; display: flex; align-items: center; justify-content: center; text-decoration: none; font-size: 14px;"
                    >
                        Youtube <i class="fa fa-youtube" style="font-size: 18px; margin-left: 8px;"></i>
                    </a>
                </div>
                ...
                <div class="input-group mt-3" style="display: flex;">
                    <a 
                        href="https://www.instagram.com/anantamelodyverses?igsh=NmQ1NGltY3VqZGhw&utm_source=qr" 
                        target="_blank"
                        class="form-control btn btn-primary"
                        style="background-color:#C13584; color: white; font-weight: 600; padding: 12px 18px; border-radius: 10px; text-align: center; display: flex; align-items: center; justify-content: center; text-decoration: none; font-size: 14px;"
                    >
                        Instagram <i class="fa fa-instagram" style="font-size: 18px; margin-left: 8px;"></i>
                    </a>
                </div>
                ...
                <div class="input-group mt-3" style="display: flex;">
                    <a 
                        href="https://www.facebook.com/profile.php?id=61585786533006" 
                        target="_blank"
                        class="form-control btn btn-primary"
                        style="background-color:#1877F2; color: white; font-weight: 600; padding: 12px 18px; border-radius: 10px; text-align: center; display: flex; align-items: center; justify-content: center; text-decoration: none; font-size: 14px;"
                    >
                        Facebook <i class="fa fa-facebook" style="font-size: 18px; margin-left: 8px;"></i>
                    </a>
                </div>
                ...
                <div class="input-group mt-3" style="display: flex;">
                    <a 
                        href="https://wa.me/?text=https://anantamtptl.com/dashboard/user1/new_binary_registration_form.php?uid=<?php echo $hmpre .
                        $userid; ?>" 
                        target="_blank"
                        class="form-control btn btn-primary"
                ...
                <?php if ($idactive == 1) { ?>
                    <div class="input-group mt-3" style="display: flex;">
                        <a 
                            href="https://t.me/share/url?url=https://anantamtptl.com/dashboard/user1/new_binary_registration_form.php?uid=<?php echo $hmpre .
            ...
            <div class="card-body" style=" padding: 25px; margin-top: 20px; color: white; box-shadow: 0 2px 15px rgba(0,0,0,0.6); border: 1px solid rgba(255,255,255,0.1);">
                ...
                <div style="margin-top: 25px; font-size: 13px; color: #d1d5db; line-height: 24px;">
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        ...
                        <span><?php echo $my_directs;?></span>
                    </div>
                    
                    <div style="display: flex; justify-content: space-between;">
                        <span>Inactive Team</span>
                        <span><?php echo $total_team - ($my_left_active_directs + $my_right_active_directs);?></span>
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        <span>Team Business (Left/Right)</span>
                        <span><?php echo $hmcurrency.$directbusinesstotalleft. "/" .$hmcurrency.$directbusinesstotalright; ?></span>
                    </div>
                    ...
                    <div style="display: flex; justify-content: space-between;">
                        <span>Total Team (All)</span>
                        <span><?php echo $total_team; ?></span>
                    </div>
