...
<style>
/* =========================================================
   ANANTA FINTECH THEME - LEFT TEAM REDESIGN
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            <span class="badge" style="background: rgba(2, 132, 199, 0.15); color: #0284c7; font-size: 11px; font-weight: 700; border-radius: 100px; padding: 4px 12px; letter-spacing: 0.5px;">BINARY NETWORK</span>
                                            <span style="font-size: 12px; color: #64748b; font-weight: 600;">LEFT SIDE</span>
                                        </div>
                                        <h4 class="mb-0" style="font-size: 22px; font-weight: 800; color: #0f172a;">
                                            Left Team <span style="background: linear-gradient(135deg, #0284c7 0%, #16a34a 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Directory</span> 👈
                                        </h4>
                                        <p class="mb-0 text-muted" style="font-size: 13.5px; margin-top: 3px;">
                                            Manage and monitor all member accounts registered on your left binary leg.
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <div class="px-3 py-2" style="background: #ffffff; border-radius: 14px; border: 1px solid rgba(2, 132, 199, 0.2); box-shadow: 0 4px 12px rgba(15, 23, 42, 0.04);">
                                        <span class="text-muted d-block" style="font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Total Left Team</span>
                                        <span class="font-weight-bold" style="font-size: 18px; color: #0284c7; font-weight: 800;"><?php echo number_format($left_team ?? 0); ?> Members</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ananta-fintech-card">
                            ...
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4><i class="fa fa-users text-primary me-2"></i> Left Team Members List</h4>
                                    <p>Real-time downline genealogy data for your left branch</p>
                                </div>
            ...
            let table = $('#usersTable').DataTable({
                ...
                columns: [
                    ...
                    { 
                        data: 'joining_date',
                        render: function(data) {
                            return '<span style="color: #64748b; font-size: 13px;"><i class="fa fa-calendar-o me-1 text-primary"></i>' + data + '</span>';
                        }
                    },
                    { data: 'status' }
                ],
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Left_Team_Members'
                    }
                ],
                language: {
                    search: "_INPUT_",
                    searchPlaceholder: "Search left team members...",
