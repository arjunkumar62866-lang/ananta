...
<style>
/* =========================================================
   ANANTA FINTECH THEME - RANK AND REWARDS REDESIGN
...
/* Header Banner */
.income-header-card {
    background: linear-gradient(135deg, rgba(236, 72, 153, 0.10) 0%, rgba(139, 92, 246, 0.10) 100%), #ffffff !important;
...
table.ananta-custom-table tbody tr:hover {
    background-color: rgba(236, 72, 153, 0.03) !important;
}
                ...
                <div class="mb-3">
                    <nav aria-label="breadcrumb">
                        <div style="display: inline-flex; flex-direction: row; align-items: center; gap: 8px; padding: 6px 14px; background: #f1f5f9; border: 1px solid #e2e8f0; border-radius: 10px; font-size: 13.5px; font-weight: 600; white-space: nowrap;">
                            ...
                            <span style="color: #94a3b8; font-weight: 400;">/</span>
                            <span style="color: #0f172a; font-weight: 700;">5. Rank Reward</span>
                        </div>
                    </nav>
                </div>
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            <span class="badge" style="background: rgba(236, 72, 153, 0.15); color: #ec4899; font-size: 11px; font-weight: 700; border-radius: 100px; padding: 4px 12px; letter-spacing: 0.5px;">REWARDS & INCENTIVES</span>
                                        ...
                                        <h4 class="mb-0" style="font-size: 22px; font-weight: 800; color: #0f172a;">
                                            Rank & Rewards <span style="background: linear-gradient(135deg, #ec4899 0%, #8b5cf6 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Statement</span> 🎁
                                        </h4>
                                        <p class="mb-0 text-muted" style="font-size: 13.5px; margin-top: 3px;">
                                            Detailed history of reward bonuses and rank milestone incentives credited to your account.
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <div class="px-3 py-2" style="background: #ffffff; border-radius: 14px; border: 1px solid rgba(236, 72, 153, 0.2); box-shadow: 0 4px 12px rgba(15, 23, 42, 0.04);">
                                        <span class="text-muted d-block" style="font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Total Rewards Earned</span>
                                        <span class="font-weight-bold" style="font-size: 18px; color: #ec4899; font-weight: 800;"><?php echo $hmcurrency . " " . number_format($reward_income_total, 2); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ananta-fintech-card">
                            ...
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4><i class="fa fa-award text-pink me-2" style="color: #ec4899;"></i> Reward Income Transactions</h4>
                                    <p>Real-time log of rank reward bonuses</p>
                                </div>
        ...
        $(document).ready(function () {
            let table = $('#usersTable').DataTable({
                ...
                columns: [
                    ...
                    { 
                        data: 'subject',
                        render: (data) => '<span style="font-weight: 600; color: #1e293b;">' + (data || 'Reward Income') + '</span>'
                    },
                    { 
                        data: 'type',
                    ...
                    { 
                        data: 'created_date',
                        render: (data) => '<span style="color: #64748b; font-size: 13px;"><i class="fa fa-calendar-o me-1" style="color: #ec4899;"></i>' + (data || 'N/A') + '</span>'
                    },
                    { 
                        data: 'time',
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Reward_Income_Statement'
                    }
                ],
                language: {
                    search: "_INPUT_",
                    searchPlaceholder: "Search reward income...",
