...
<head>
  ...
  <style>
    ...
    /* Remove animated spider-net / particles */
    #particles-js {
...
<body class="bg-theme bg-theme1">
  ...
  <!-- Particles container kept but hidden -->
      ...
      <div class="card-body p-4 p-md-5">
        ...
        <div class="text-center mb-4">
          ...
          <?php else: ?>
            ...
            <h2 style="font-weight: 800; color: #0284c7; letter-spacing: -0.5px; margin: 0;">
              ANANTA
            </h2>
          ...
          <h4 class="mt-3 mb-1" style="font-size: 22px; font-weight: 800; color: #0f172a;">
            Welcome to ANANTA
          </h4>


          <p class="text-muted mb-0" style="font-size: 14px; font-weight: 600;">
        ...
        <div style="background: #f8fafc; border-radius: 16px; border: 1.5px solid #cbd5e1; padding: 18px; margin-bottom: 24px;">
          ...
          <div class="d-flex align-items-center justify-content-between py-2 border-bottom">
            ...
            <span style="font-size: 15px; font-weight: 800; color: #0284c7; font-family: monospace;" id="msgUserId">
              <?php echo $hmpre . $userdata['userid']; ?>
            </span>
          ...
          <div class="d-flex align-items-center justify-content-between py-2 border-bottom">
            ...
            <span style="font-size: 15px; font-weight: 800; color: #0f172a; font-family: monospace;">
              <?php echo htmlspecialchars($userdata['pass']); ?>
            </span>
          ...
          <div class="d-flex align-items-center justify-content-between py-2 border-bottom">
            ...
            <span style="font-size: 15px; font-weight: 800; color: #16a34a; font-family: monospace;">
              <?php echo htmlspecialchars($userdata['txn_pass']); ?>
            </span>
          ...
          <div class="d-flex align-items-center justify-content-between py-2">
            ...
            <span style="font-size: 14px; font-weight: 700; color: #334155;">
              <?php echo $hmpre . $userdata['sponserid']; ?>
            </span>
        ...
        <div style="background: #fef2f2; border-left: 4px solid #ef4444; border-radius: 10px; padding: 12px 14px; margin-bottom: 24px;">
          ...
          <p style="color: #991b1b; margin: 0; font-size: 12.5px; font-weight: 600;">
            ...
            Do not share your password or Transaction Key with anyone.
        ...
        <a href="login.php" 
           class="btn text-white font-weight-bold w-100 d-inline-flex align-items-center justify-content-center gap-2" 
           style="height: 50px; background: linear-gradient(135deg, #0284c7 0%, #16a34a 100%); border-radius: 12px; font-size: 16px; text-decoration: none; box-shadow: 0 8px 25px rgba(2, 132, 199, 0.25);">
  ...
  <!-- Particles scripts kept as original -->
