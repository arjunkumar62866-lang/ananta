...
<div class="content-wrapper py-4" style="background-color: #faf9f6 !important;">
    <div class="container-fluid">
        ...
        <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-4 pb-2 border-bottom">
            <div>
                <h4 class="mb-1 font-weight-bold" style="color: #0f172a; font-family: 'Plus Jakarta Sans', sans-serif;">Profit Income</h4>
                <p class="text-muted small mb-0">Daily investment profit & yield distribution statement</p>
            </div>
            <nav aria-label="breadcrumb">
                <div style="display: inline-flex; flex-direction: row; align-items: center; gap: 8px; padding: 6px 14px; background: #f1f5f9; border: 1px solid #e2e8f0; border-radius: 10px; font-size: 13.5px; font-weight: 600; white-space: nowrap;">
                    ...
                    <span style="color: #94a3b8; font-weight: 400;">/</span>
                    <span style="color: #0f172a; font-weight: 700;">1. Profit Income</span>
                </div>
            </nav>
        </div>

        <!-- Metric Stat Banner -->
        <div class="card border-0 shadow-sm mb-4" style="background: linear-gradient(135deg, rgba(2, 132, 199, 0.08) 0%, rgba(22, 163, 74, 0.08) 100%), #ffffff; border: 1px solid #e2e8f0 !important; border-radius: 20px;">
            <div class="card-body p-4 d-flex align-items-center justify-content-between flex-wrap gap-3">
                <div class="d-flex align-items-center">
                    <div class="rounded-circle p-3 mr-3" style="background: linear-gradient(135deg, #0284c7 0%, #0369a1 100%); color: #ffffff; box-shadow: 0 8px 20px rgba(2, 132, 199, 0.3);">
                        <i class="zmdi zmdi-chart-donut zmdi-hc-2x"></i>
                    </div>
                    <div>
                        <span class="text-muted small text-uppercase font-weight-bold">Total Accumulated Profit Income</span>
                        <h3 class="mb-0 font-weight-bold" style="color: #0f172a;">
                            <?php echo formatCurrency($profitTotal, $selectedCurrency); ?>
                        </h3>
                    </div>
                </div>
                <div>
        ...
        <div class="card border-0 shadow-sm" style="background: #ffffff; border: 1px solid #e2e8f0 !important; border-radius: 18px;">
            <div class="card-header bg-white py-3" style="border-bottom: 1px solid #f1f5f9; border-radius: 18px 18px 0 0;">
                <h6 class="m-0 font-weight-bold" style="color: #0f172a;">
                    <i class="zmdi zmdi-receipt mr-2" style="color: #0284c7;"></i> Profit Income Transaction Records
                </h6>
            </div>
                                ...
                                <?php $sr = 1; foreach ($history as $h): ?>
                                    <tr style="border-bottom: 1px solid #f1f5f9;">
                                        ...
                                        <td class="py-3 px-3 font-weight-semibold" style="color: #0f172a;">
                                            <?php echo htmlspecialchars($h['subject'] ?? 'Daily Profit Income'); ?>
                                        </td>
                            ...
                            <?php else: ?>
                                <tr>
                                    <td colspan="5" class="text-center py-5 text-muted">
                                        ...
                                        No profit income transactions found yet.
                                    </td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
