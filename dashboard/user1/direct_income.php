...
// Calculate Total Direct Income for header stat
$table = "tbl_levelinc";
$direct_income_total = incometotalnew($pdo, $table, $userid, 'Direct Income');
$direct_income_total = round((float)($direct_income_total ?? 0), 2);
?>

<style>
/* =========================================================
   ANANTA FINTECH THEME - DIRECT INCOME REDESIGN
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            <span class="badge" style="background: rgba(22, 163, 74, 0.15); color: #16a34a; font-size: 11px; font-weight: 700; border-radius: 100px; padding: 4px 12px; letter-spacing: 0.5px;">DIRECT COMMISSIONS</span>
                                            <span style="font-size: 12px; color: #64748b; font-weight: 600;">REFERRAL EARNINGS</span>
                                        </div>
                                        <h4 class="mb-0" style="font-size: 22px; font-weight: 800; color: #0f172a;">
                                            Direct Income <span style="background: linear-gradient(135deg, #16a34a 0%, #0284c7 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">Statement</span> ⚡
                                        </h4>
                                        <p class="mb-0 text-muted" style="font-size: 13.5px; margin-top: 3px;">
                                            Complete ledger of direct sponsor commissions and referral rewards credited to your account.
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <div class="px-3 py-2" style="background: #ffffff; border-radius: 14px; border: 1px solid rgba(22, 163, 74, 0.2); box-shadow: 0 4px 12px rgba(15, 23, 42, 0.04);">
                                        <span class="text-muted d-block" style="font-size: 11px; font-weight: 700; text-transform: uppercase; letter-spacing: 0.5px;">Total Direct Income</span>
                                        <span class="font-weight-bold" style="font-size: 18px; color: #16a34a; font-weight: 800;"><?php echo $hmcurrency . " " . number_format($direct_income_total, 2); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ananta-fintech-card">
                            ...
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4><i class="fa fa-list-alt text-success me-2"></i> Direct Income Transactions</h4>
                                    <p>Real-time log of direct referral income credits</p>
                                </div>
        ...
        $(document).ready(function () {
            let table = $('#usersTable').DataTable({
                ...
                columns: [
                    ...
                    { 
                        data: 'subject',
                        render: (data) => '<span style="font-weight: 600; color: #1e293b;">' + (data || 'Direct Income') + '</span>'
                    },
                    { 
                        data: 'type',
                    ...
                    { 
                        data: 'created_date',
                        render: (data) => '<span style="color: #64748b; font-size: 13px;"><i class="fa fa-calendar-o me-1 text-success"></i>' + (data || 'N/A') + '</span>'
                    },
                    { 
                        data: 'time',
                ...
                buttons: [
                    {
                        extend: 'excelHtml5',
                        title: 'Direct_Income_Statement'
                    }
                ],
                language: {
                    search: "_INPUT_",
                    searchPlaceholder: "Search direct income...",
