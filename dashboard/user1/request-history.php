                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            <span class="badge" style="background: rgba(2, 132, 199, 0.15); color: #0284c7; font-size: 11px; font-weight: 700; border-radius: 100px; padding: 4px 12px; letter-spacing: 0.5px;">FUND REQUEST LOG</span>
                                            <span style="font-size: 12px; color: #64748b; font-weight: 600;">TRANSACTION HISTORY</span>
                                        </div>
                                        <h4 class="mb-0" style="font-size: 22px; font-weight: 800; color: #0f172a;">
                                            Fund Request <span style="background: linear-gradient(135deg, #0284c7 0%, #16a34a 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">History</span> 📑
                                        </h4>
                                        <p class="mb-0 text-muted" style="font-size: 13.5px; margin-top: 3px;">
                                            View complete status logs of your submitted deposit requests.
                                        </p>
                                    </div>
                                </div>
                                <div>
                                    <a href="fund-request.php" class="btn btn-primary font-weight-bold px-3 py-2" style="border-radius: 12px; font-size: 13px; background: linear-gradient(135deg, #0284c7 0%, #16a34a 100%); border: none;">
                                        <i class="fa fa-plus me-1"></i> New Fund Request
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ananta-fintech-card">
                            ...
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4><i class="fa fa-list text-primary me-2"></i> Deposit Request Records</h4>
                                    <p>Real-time status updates of your deposit submissions</p>
                                </div>
                ...
                columns: [
                    ...
                    },
                    {
                        ...
                        render: function (data) {
                            return '<span style="font-weight: 700; color: #0284c7; font-family: monospace; background: rgba(2,132,199,0.08); padding: 4px 10px; border-radius: 8px;"><?php echo $hmpre; ?>' + data + '</span>';
                        }
                    },
                    { 
                        data: 'tr_id',
