...
<style>
/* =========================================================
   ANANTA FINTECH THEME - ENQUIRY HISTORY REDESIGN
========================================================= */
html, body {
    min-height: 100%;
    margin: 0;
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <div class="d-flex align-items-center gap-2 mb-1">
                                            <span class="badge" style="background: rgba(2, 132, 199, 0.15); color: #0284c7; font-size: 11px; font-weight: 700; border-radius: 100px; padding: 4px 12px; letter-spacing: 0.5px;">SUPPORT LOGS</span>
                                            <span style="font-size: 12px; color: #64748b; font-weight: 600;">HELP DESK</span>
                                        </div>
                                        <h4 class="mb-0" style="font-size: 22px; font-weight: 800; color: #0f172a;">
                                            Enquiry <span style="background: linear-gradient(135deg, #0284c7 0%, #16a34a 100%); -webkit-background-clip: text; -webkit-text-fill-color: transparent;">History</span> 📨
                                        </h4>
                                        <p class="mb-0 text-muted" style="font-size: 13.5px; margin-top: 3px;">
                                            Track the resolution status of all your submitted support enquiry tickets.
                                        </p>
                                    </div>
                                </div>
                                <div class="d-flex align-items-center gap-2 flex-wrap">
                                    <a href="enquery.php" class="btn btn-primary font-weight-bold px-3 py-2" style="border-radius: 12px; font-size: 13px;">
                                        <i class="fa fa-paper-plane me-1"></i> Send New Enquiry
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="ananta-fintech-card">
                            ...
                            <div class="card-header-bar">
                                <div class="card-header-title">
                                    <h4><i class="fa fa-list-alt text-primary me-2"></i> Support Ticket Records</h4>
                                    <p>Comprehensive status list of all support queries</p>
                                </div>
                                <div>
                ...
                columns: [
                    ...
                    { 
                        ...
                        render: function(data) {
                            return '<span class="badge bg-light text-dark font-weight-bold border px-2 py-1">' + (data || '') + '</span>';
                        }
                    },
                    { data: 'sub' },
                    { 
                        ...
                        render: function(data, type, row) {
                            if (data == '1') {
                              return '<span class="badge-status badge-status-viewed"><i class="fa fa-check-circle"></i> Viewed</span>';
                            } else if (data == '0') {
                              return '<span class="badge-status badge-status-pending"><i class="fa fa-clock-o"></i> Pending</span>';
                            } else if (data == '2') {
                              return '<span class="badge-status badge-status-reject"><i class="fa fa-times-circle"></i> Rejected</span>';
                            } else {
