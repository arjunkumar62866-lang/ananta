(function($) {
	...
	if($('.curved-circle').length) {
        $('.curved-circle').circleType({position: 'absolute', dir: 1, radius: 55, forceHeight: true, forceWidth: true});
    }

	if($('.curved-circle-2').length) {
        $('.curved-circle-2').circleType({position: 'absolute', dir: 1, radius: 75, forceHeight: true, forceWidth: true});
    }

	if($('.curved-circle-3').length) {
        $('.curved-circle-3').circleType({position: 'absolute', dir: 1, radius: 67, forceHeight: true, forceWidth: true});
    }

	if($('.curved-circle-4').length) {
        $('.curved-circle-4').circleType({position: 'absolute', dir: 1, radius: 65, forceHeight: true, forceWidth: true});
    }
	...
	if($('.tabs-box-2').length){
	 ...
	 if($('.tabs-box-3').length){
		$('.tabs-box-3 .tab-buttons-3 .tab-btn-3').on('click', function(e) {
			e.preventDefault();
			var target = $($(this).attr('data-tab'));
			...
			if ($(target).is(':visible')){
				...
				target.parents('.tabs-box-3').find('.tab-buttons-3').find('.tab-btn-3').removeClass('active-btn-3');
				$(this).addClass('active-btn-3');
				target.parents('.tabs-box-3').find('.tabs-content-3').find('.tab-3').fadeOut(0);
				target.parents('.tabs-box-3').find('.tabs-content-3').find('.tab-3').removeClass('active-tab-3');
				$(target).fadeIn(300);
				$(target).addClass('active-tab-3');
			}
		});
	}
